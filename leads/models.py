...
class Company(BaseModel):
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="leads_company_created_by"
    )
    updated_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="leads_company_updated_by"
    )
...
class Lead(BaseModel):
    ...
    assigned_to = models.ManyToManyField(
        Profile, related_name="leads_lead_assigned_to"
    )
    ...
    tags = models.ManyToManyField(Tags, blank=True, related_name="leads_lead_tags")
    contacts = models.ManyToManyField(Contact, related_name="leads_lead_contacts")
    created_from_site = models.BooleanField(default=False)
    teams = models.ManyToManyField(Team, related_name="leads_lead_teams")
    org = models.ForeignKey(
        Org,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="leads_lead_org"
    )
    company = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="leads_lead_company"
    )
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="leads_lead_created_by"
    )
    updated_by = models.ForeignKey(
        Profile,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="leads_lead_updated_by"
    )

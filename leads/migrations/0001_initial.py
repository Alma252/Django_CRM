    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='leads_company_created_by', to='common.profile')),
                ('org', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='leads_companies', to='common.org')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='leads_company_updated_by', to='common.profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ManyToManyField(related_name='leads_lead_assigned_to', to='common.profile')),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='leads_lead_company', to='leads.company')),
                ('contacts', models.ManyToManyField(related_name='leads_lead_contacts', to='contacts.contact')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='leads_lead_created_by', to='common.profile')),
                ('org', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='leads_lead_org', to='common.org')),
                ('tags', models.ManyToManyField(blank=True, related_name='leads_lead_tags', to='accounts.tags')),
                ('teams', models.ManyToManyField(related_name='leads_lead_teams', to='teams.team')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='leads_lead_updated_by', to='common.profile')),
            ],
            options={
                'verbose_name': 'Lead',
